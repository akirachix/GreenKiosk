...
class RvProductOrderAdapter(
    ...
    override fun onBindViewHolder(holder: ProductOrdersViewHolder, position: Int) {
        ...
        holder.processedToCheckout.setOnClickListener {
...
class ProductOrdersViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    ...
    var processedToCheckout: TextView =itemView.findViewById(R.id.processedToCheckout)
}
